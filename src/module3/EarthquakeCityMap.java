...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
	    ...
	    //print statements to show relevant properties
	    ...
	    //Setup colours - use american english
	    ...
	    //Setting marker colours based on magnitude of earthquake
	    for (Marker mk: markers) {
	    	float magnit = (float) mk.getProperty("magnitude");
	    	//magnitudes less than 4 are yellow and of radius 6
	    	if (magnit<4) {
	    		mk.setColor(blue);
	    		((SimplePointMarker) mk).setRadius(6);
	    	}
	    	else {
	    		//magnitudes between 4 and 4.9 are yellow
	    		if (magnit>=4 && magnit <=4.9) {
	    			mk.setColor(yellow);
	    			((SimplePointMarker) mk).setRadius(12);
	    		}
	    		else {
	    			//magnitudes above 4.9 are red
	    			mk.setColor(red);
