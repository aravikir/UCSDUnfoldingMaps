...
public class EarthquakeCityMap extends PApplet {
	...
	{
		for (Marker m: countryMarkers) {
			//setup counts for in country and in ocean
			int count = 0;
			int oceanCount = 0;
			//check over data for properties of the earthquakes
			for (Marker q: quakeMarkers) {
				if(q.getProperty("country")==m.getProperty("name")) {
					count++;
				}
			...
			System.out.println("Quakes in ocean: " + oceanCount);
		}		
